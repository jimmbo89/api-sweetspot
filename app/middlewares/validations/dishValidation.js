...
const storeDishSchema = Joi.object({
  ...
  status: Joi.number().integer().default(0).optional().messages({
    ...
    "number.integer": '"status" debe ser un entero',
  }),
});
...
const updateDishSchema = Joi.object({
  ...
  status: Joi.number().integer().allow(null).empty("").optional().messages({
    "number.base": '"status" debe ser un número',
    "number.integer": '"status" debe ser un entero',
  }),
...
const filterDishSchema = Joi.object({
  business_id: Joi.number().integer().required().messages({
    "number.base": '"business_id" debe ser un número',
    "number.integer": '"business_id" debe ser un entero',
    "any.required": '"business_id" es un campo obligatorio',
